...
THREE.OrbitControls = function ( object, domElement ) {
	...
	// The interval [ - Math.PI, Math.PI ] increases the horizontal bounds
	// and the interval [ - Math.PI, Math.PI ] reduces the horizontal bounds.
	// If set to null or undefined, the horizontal bounds are unlimited.
	...
	this.update = function () {
		...
		return function update() {
			...
			scope.target.addScaledVector( panOffset, scope.panSpeed );
	...
	// make sure element can receive key events

	//scope.domElement.setAttribute( 'tabindex', - 1 );
